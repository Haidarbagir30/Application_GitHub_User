...
import com.learning.aplikasigithubuser.databinding.ActivityMainBinding
import com.learning.aplikasigithubuser.detail.DetailActivity
import com.learning.aplikasigithubuser.detail.costume.SettingActivity
import com.learning.aplikasigithubuser.favorite.FavoriteActivity
...
class MenuActivity : AppCompatActivity() {
   ...
   private val viewModel by viewModels<MainViewModel>{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //buatnampilin searchview yang disambungin ke API
...
//Entity = Table
//Dao = Kumpulan Query
//AppDatabase = mengkonfigurasi dari database room