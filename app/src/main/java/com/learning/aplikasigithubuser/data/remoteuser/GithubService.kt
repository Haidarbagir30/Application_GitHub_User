...
import com.learning.aplikasigithubuser.BuildConfig
import com.learning.aplikasigithubuser.data.model.Item
import com.learning.aplikasigithubuser.data.model.RensponseUserGithub
...
interface GithubService {
    ...
    @GET("users")
    suspend fun getUserGithub(@Header("Authorization")
